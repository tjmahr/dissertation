...
```{r peak-concurrent-vocab-cors, fig.cap = "(ref:peak-concurrent-vocab-cors)", out.width = "75%", fig.width = 6, fig.height = 3}
theme_set(theme_teej())
...
```{r age-5-from-peaks, fig.cap = "(ref:age-5-from-peaks)", out.width = "60%", fig.height = 5, fig.width = 5}
w_l <- w_evt %>% 
