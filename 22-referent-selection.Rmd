...
```{r aim2-real-nonword-means, fig.cap = "(ref:aim2-real-nonword-means)", out.width = out_tex100_else80, fig.height = 4, fig.width = 6}
theme_set(theme_teej())
# m_tp1
# m_tp2
# m_tp3
...
```{r aim2-gca-peaks, fig.cap = "(ref:aim2-gca-peaks)", out.width = out_tex80_else66, fig.height = 3, fig.width = 4.5}
...
peaks_and_vocabs_w %>%
  ...
  knitr::kable(
    align = c("lllll"),
    caption = "Correlation between curve peaks and vocabulary measures")
...
```{r age-5-from-peaks, fig.cap = "(ref:age-5-from-peaks)", out.width = out_tex100_else60, fig.height = 5, fig.width = 5}
w_l <- w_evt %>% 
...
`r p_both`. The condition differences did predict age-5 vocabulary: A .1
...
environment may cause children to downweight the syllable-initial sounds.
Such an adaptation would lead to lower overall activation of the real
words. This possibility is a limitation of this study: A design with
just real words and nonwords would provide a better comparison of the
two kinds of words. Alternatively, the novelty bias could interfere with
processing of familiar words. For some trials, children could have
