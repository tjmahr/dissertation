...
words---a difference (nonword advantage) of `r d_NonwordvReal`. For the
...
Descriptive statistics reveal the developmental trends for this
task. At age 3, the median peak values were similar for the two
conditions, both around .83. The peaks increased for the nonword
...
greater*. In other words, half the children performed near the ceiling
on this task by age 4. 
...
**Summary**. Children performed similiarly for real words and nonwords
...
vocabulary, *p* = `p_real`. There was a significant effect of the
...
The advantage of nonwords over real words was an unexpected result. My
...
third possibility of an overall advantage for nonwords over real words.
