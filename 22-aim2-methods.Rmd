...
(ref:sample-mp-screen-scap) Example displays for a trial in which *duck* is mispronounced as "guck" and a trial in which the nonword "cheem" is presented.
...
```{r novelty-bias, fig.cap = "(ref:novelty-bias)", fig.scap = "(ref:novelty-bias)", out.width = out_tex80_else50, echo = FALSE, message = FALSE, warnings = FALSE, fig.width = 5, fig.height = 3.5, out.width = out_tex80_else66}
...
(ref:aim2-real-word-spaghetti-scap) Empirical word recognition growth curves from each year of the study for the real word condition. 
...
(ref:aim2-nonword-spaghetti-scap) Empirical word recognition growth curves for nonword condition.
...
(ref:aim2-mispronunciation-spaghetti-scap) Empirical word recognition growth curves for mispronunciation condition.
...
mp_super <- p2_mp + p1_mp + 
  plot_layout(widths = c(4, 6)) + 
  plot_annotation("\"Find the shoop\": Child hears a mispronunciation")
