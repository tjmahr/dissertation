...
```{r aim2-real-word-spaghetti, fig.width = 7, fig.height = 4.5, out.width = "100%"}
library(patchwork)
rw_super <- p2 + p1 + 
...
```{r aim2-nonword-spaghetti, fig.width = 7, fig.height = 4.5, out.width = "100%"}
nw_super
```

```{r aim2-mispronunciation-spaghetti, fig.width = 7, fig.height = 4.5, out.width = "100%"}
mp_super
```
