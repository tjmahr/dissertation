...
```{r aim2-real-word-spaghetti, fig.cap = "(ref:aim2-real-word-spaghetti)", fig.width = 7, fig.height = 4.5, out.width = "100%"}
library(patchwork)
rw_super <- p2 + p1 + 
...
```{r aim2-nonword-spaghetti, fig.cap = "(ref:aim2-nonword-spaghetti)", fig.width = 7, fig.height = 4.5, out.width = "100%"}
nw_super
```

```{r aim2-mispronunciation-spaghetti, fig.cap = "(ref:aim2-mispronunciation-spaghetti)",  fig.width = 7, fig.height = 4.5, out.width = "100%"}
mp_super
```
...
ggplot(d2) + 
  ...
  labs(
    ...
    title = "Growing novelty preference for nonword trials",
    caption = constants$cap_mean_se) + 
  guides(color = FALSE, linetype = FALSE) + 
  theme_teej(base_size = 18) +
  theme(
    strip.background.y = element_blank(), 
    strip.text.y = element_blank(),
    strip.background.x = element_blank(), 
