...
the building a lexicon as a design or enginneering problem. It considers
...
A similar study by Baily and Plunkett (2002) tackled the representations
...
a familar image than a 2-feature mispronunciation, and a 2-feature
...
the two unfamilar objects were presented and prompted (*Where's the
...
@Bion2013 found that toddler performed better on the familiar-word
trials than the novel-word trials. But if we think of the nonwords as
just much, much less familiar words, then this result is wholly
...
The study is described in detail in [Chapter \@ref(aim1-method)](#aim2-method).

In [Chapter \@ref(fam-rec)](#real-nonword-selection), I examine
...
In [Chapter \@ref(lex-competitors)](#sensitivity-to-mispronunciations), I
...
not formally modelled. Finally, in 
...
<!-- [^friends]: I am reminded of the saying, "a stranger is just a friend you haven't met yet." A nonword is just a word you haven't learned yet. -->
