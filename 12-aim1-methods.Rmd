...
This experimental design---an eyetracking study word recognition with
...
phonological and semantic competitor I focus on subsets of competitors:
the shared syllable onsets for the phonological competitors and the
...
knitr::kable(
  ...
  caption = glue::glue(
    "Eyetracking data before and after data screening. For convenience, the \\
     number of exclusions is included as Raw − Screened. Percent Missing: \\
...
looks by child, study and time, and created orthogonal polynomials to
use as time features for the model.
