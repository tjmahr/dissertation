...
for Table \@ref(tab:mp-norming-table).
...
both %>% 
  knitr::kable(
    align = "lllrr", 
    booktabs = TRUE, 
    caption = "Results for the item recognition tests.")
```
...
#   set_bold(row = final(2), col = everywhere, TRUE) %>% 
#   set_bold(row = 1, col = everywhere, TRUE) %>% 
#   set_align(
#     row = everywhere, 
#     col = c("Trials Correct", "Percent Correct"), 
#     "right") %>% 
#   set_caption("Results for the item recognition tests.")
# 
# ht
```
...
intercepts for child, child x item type, item, and
...
```{r mp-norm-trials-by-peak, fig.cap = "(ref:mp-norm-trials-by-peak)", fig.width=5, fig.height=3.5, out.width="50%"}
aaa %>% 
