...
At age 3 and age 4, the growth curves sharply fall into chance-level
performance. Behaviorally, they are looking to both images equally. 
...
```{r fam-initial-mp-trials, fig.width=5, fig.height=4, out.width="66%"}
f_newdata <- d_f %>% 
  distinct(Study, ResearchID, Time, ot1, ot2, ot3) %>% 
  mutate(Target = 0, Trials = 30)
...
make combine in subtle ways. Figure XX shows how the growth curve
features are weighted at each year. For the intercept (average
probability), age 4 was lower than age 3, XXX vs XXX, and age 5 was
higher than age 4, increase by XXX. For the linear time term, the slope
becomes flatter from age 3 to age 4, an X% decrease, and from age 4 to
age 5, an X% decrease. I think of a positive quadratic trend like a
...
credible differences in the cubic time component. The combination of
...
test <- posterior_samples(mp_fam, pars = "^b_") %>% 
  transmute(
    ...
    d_ot1_Age4 = b_ot1_Age4 - b_ot1_Age3,
    d_ot1_Age5 = b_ot1_Age5 - b_ot1_Age4,
    per_d_ot1_Age4 = (b_ot1_Age4 - b_ot1_Age3) / b_ot1_Age3,
    per_d_ot1_Age5 = (b_ot1_Age5 - b_ot1_Age4) / b_ot1_Age4,
    d_ot2_Age4 = b_ot2_Age4 - b_ot2_Age3,
    d_ot2_Age5 = b_ot2_Age5 - b_ot2_Age4,
    d_ot3_Age4 = b_ot3_Age4 - b_ot3_Age3,
    d_ot3_Age5 = b_ot3_Age5 - b_ot3_Age4)

mcmc_intervals(data.frame(x = test$per_d_ot1_Age4))
# 
# mcmc_intervals(test, regex_pars = "Intercept_A")
# mcmc_intervals(test, regex_pars = "Intercept_Prop")
# mcmc_intervals(test, regex_pars = "ot1_Age")
