...
Age and interactions Time × Age interactions, like the one from
...
`r study_counts_f$T3` at age 5, and for the unfamiliar-initial trials,
...
children on average looked more to the familiar image than the unfamiliar
