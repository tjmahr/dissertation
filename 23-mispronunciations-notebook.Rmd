...
```{r age3-valley-curves, fig.cap = "(ref:age3-valley-curves)", width = 6, height = 6, out.width=out_tex100_else80}
...
```{r mp-fam-valley-evt, fig.cap = "(ref:mp-fam-valley-evt)", out.width = out_tex80_else50, fig.width = 4.25, fig.height = 4}
# Get 100 samples of peaks to model
to_model <- fam_peaks %>% 
  sample_n_of(100, .draw) %>% 
  left_join(scores) 
...
```{r mp-fam-prop-ot2-bins, fig.cap = "(ref:mp-fam-prop-ot2-bins)", width = 6, height = 6, out.width=out_tex100_else80}
set.seed(20180713)
...
```{r mp-norm-trials-by-peak, fig.cap = "(ref:mp-norm-trials-by-peak)", fig.width=5, fig.height=3.5, out.width=out_tex80_else66}
aaa %>% 
...
```{r mp-vs-real-peaks, fig.cap = "(ref:mp-vs-real-peaks)", fig.width=4, fig.height=3, out.width=out_tex80_else50}
p_mp_real
```
