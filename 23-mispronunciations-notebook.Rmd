...
`r props$b_mean_mispronunciation_prop`. For a child with an average peak
on the nonword trials (`r mean_nw_peak`), the predicted proportion
correct on the mispronunciation retention trials was
`r props$b_mean_nonword_prop`. A 1-SD (`r sd_mp_peak`) increase in
...
proportion correct of `r props_sd$d_mean_upsd_nonword_prop`. The
