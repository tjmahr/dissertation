...
```{r pairwise-effects, fig.cap = "(ref:pairwise-effects)", fig.show = 'hold', echo = FALSE, out.width = "50%", fig.height = 4, fig.width = 4}
clean_names <- . %>% 
...
intervals3 <- draws %>% 
  mcmc_intervals_data(
    regex_pars = "Intercept", transformations = "plogis", 
