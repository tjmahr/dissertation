...
The average looking probability (intercept feature) was `r int_pts$TP1`
[90% UI: `r int_uis$TP1`] at age 3, `r int_pts$TP2`
[`r int_uis$TP2`] at age 4, and `r int_pts$TP3` [`r int_uis$TP3`] at
age 5. The averages increased by `r int_dpts$TP2_TP1`
[`r int_duis$TP2_TP1`] from age 3 to age 4 and by `r int_dpts$TP3_TP2`
[`r int_duis$TP3_TP2`] from age 4 to age 5. The peak looking
probability was `r peak_pts$TP1` [`r peak_uis$TP1`] at age 3,
`r peak_pts$TP2` [`r peak_uis$TP2`] at age 4, and `r peak_pts$TP3`
[`r peak_uis$TP3`] at age 5. The peak values increased by
`r peak_dpts$TP2_TP1` [`r peak_duis$TP2_TP1`] from age 3 to age 4 and
by `r peak_dpts$TP3_TP2` [`r peak_duis$TP3_TP2`] from age 4 to age 5.
...
`r new_peaks_pts$TimePoint1` [90% UI: `r new_peaks_uis$TimePoint1`],
peak<sub>4</sub> = `r new_peaks_pts$TimePoint2`
[`r new_peaks_uis$TimePoint2`], peak<sub>5</sub> =
`r new_peaks_pts$TimePoint3` [`r new_peaks_uis$TimePoint3`]. Moreover,
...
and 5^th^ percentiles was `r new_peaks_diff$TimePoint1` for age 3,
`r new_peaks_diff$TimePoint2` for age 4, and
`r new_peaks_diff$TimePoint3` for age 5.
...
(vers. `r packageVersion("irr")`, CITATION) to compute concordance
...
[`r int_ppvt_tp2_pts[["TP1 - TP2"]]`], and the correlation for age 3
