...
receptive vocabulary. (The receptive test was not administered during year
3.) As with the concordance statistics, we compute each of the statistics for
each sample of the posterior distribution so we would obtain a distribution of
correlations.

Figure \@ref(fig:evt2-gca-cors) shows the correlations of the intercept and linear time features with expressive vocabulary size at year 3. For all casses 
...
(ref:evt2-gca-cors) Text reference for caption

```{r evt2-gca-cors, fig.cap = "(ref:evt2-gca-cors)", out.width = "80%", fig.height=4, fig.width=6}
...
Figure \@ref(fig:ppvt4-gca-cors) 

(ref:ppvt4-gca-cors) Text reference for caption

```{r ppvt4-gca-cors, fig.cap = "(ref:ppvt4-gca-cors)", out.width = "80%", fig.height=4, fig.width=6}
c_intervals %>% 
