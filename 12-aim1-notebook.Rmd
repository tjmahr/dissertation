...
```{r curve-features, fig.show = 'hold', echo = FALSE, out.width = "80%", fig.height = 5.5, fig.width = 5.5}
dummy_data <- d_m %>% 
...
lpred %>% 
  ...
  ggplot() + 
    ...
    labs(
      title = "Observed means and 200 posterior predictions of means",
      x = "Time after target onset [ms]",
...
timepoint 3. The peak looking probability was `r peak_pts$TP1` [90% UI: `r peak_uis$TP1`]
