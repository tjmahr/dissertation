...
maybe a few unfamilar words*. The idea is as follows: Suppose at age 3 a
child does not know four of words very well. If they had to click or tap
...
incorrectly identified words would be excluded. As it stands now, there
is no clear way to tease apart whether the lower growth curve peaks at
age 3 reflected greater uncertainty during lexical processing or a
greater number of words being unfamiliar to the children. I favor the
former interpretation because these were highly familiar words. We
piloted the images/words at least 80% recognizable to children in two
preschool classrooms, so these words should be familiar to children.

<!-- But even if some words were unfamiliar at age 3, the number -->
<!-- of unfamilar words at age 4 is likely to be very small and therefore they would exert a -->
<!-- minimal effect on the lexical processing measures. Children's peak looking probabilities increased  -->
<!-- by about .13 at age 4 (from .55 to .68) and by about .09 (to .77) at age 5. Because children also showed improvements from age 4 to age 5, when the effect of unknown words would be very small, it seems likely that the change -->
...
compare different types of trials: for example, trials with a target
...
included in the analysis of phonological competitors (which focused on just
competitors with the same syllable onset as the target). The current design
