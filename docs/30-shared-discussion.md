...
(PART\*) Overall discussion  {#part-end-matter .unnumbered}
=======================================================================

General discussion of both studies {#both-studies-discussion}
=======================================================================
...
interpretations of the data from Study 1 and Study 2, I assumed a
...
they first need to build up activation of the word and that
...
competition also explain the disruptive mispronunciation effects observed in Study 2. The
...
connections. On the mispronunciation trials from Study 2, a
...
from Study 1 show that phonologically and semantically similar
...
The results of Study 1 remind us that words
...
A final contribution comes from Study 2. This study was limited
