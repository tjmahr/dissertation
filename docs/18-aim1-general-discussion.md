...
<!-- lexical access and say that the way to cope with finding a needle in an -->
<!-- ever-growing haystack is to sort the hay and organize the straws. (Or -->
<!-- better yet, make it a *self-organizing* haystack.) I might apply the -->
<!-- reasoning backwards in time too: Early on, with just a few words, an ad -->
...
compare different types of a trials: for example, trials with a target
vs. three unrelated images intermixed with trials with a target vs. a
competitor vs. two unrelated images. The trials also used different
kinds of phonological and semantic competitors. For example, two of the
