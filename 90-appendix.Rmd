...
```{r lkj-prior, echo = FALSE, out.width = "50%", fig.height = 3, fig.width = 4, include = FALSE}
library(ggplot2)
...
```{r posterior-sds, echo = FALSE, eval = FALSE, out.width = "80%", fig.height = 2.5, fig.width = 5}
...
```{r posterior-cors, eval = FALSE, echo = FALSE, out.width = "80%", fig.height = 3, fig.width = 5}
...
```{r post-pred, eval = FALSE, fig.cap = "(ref:post-pred)", echo = FALSE, out.width = "80%", fig.height = 3, fig.width = 6}
...
```{r posterior-lines, eval = FALSE, out.width = "100%", fig.height = 4, fig.width = 5}
set.seed(09272017)
...
```{r posterior-mean-lines, eval = FALSE, out.width = "100%", fig.height = 4, fig.width = 5}
lpred <- d_m %>% 
  sample_n_of(8, ResearchID) %>% 
