...
`r phon_minp_p`. The interaction smooth between time and ability was
significant, EDF = `r phon_minp_time_edf`, `r phon_minp_time_p`. Model
...
```{r age3-phon-by-minp, fig.cap = "(ref:age3-phon-by-minp)", out.width = "80%", fig.width = 6, fig.height = 4}
