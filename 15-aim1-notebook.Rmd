...
```{r semy-diff-curves, fig.cap = "(ref:semy-diff-curves)", include = FALSE, out.width = "80%", fig.width = 5, fig.height = 3}
age5_age4 <- s2r %>%
  get_difference(
    comp = list(S2 = c("TimePoint3", "TimePoint2")),
...
```{r age3-phon-by-minp, fig.cap = "(ref:age3-phon-by-minp)", out.width = "80%", fig.width = 6, fig.height = 4, include = FALSE}
...
effect for receptive vocabulary, EDF = `r phon_ppvt_edf`,
