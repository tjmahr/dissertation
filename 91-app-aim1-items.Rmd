Items used in Aim 1 {#vw-experiment-items}
========================================================================
...
experiment in Aim 1. Each row of the table represents a set of four images used
...
words %>% 
  knitr::kable(
    caption = "Sets of four images used for the Visual World Experiment.")
```
...
phono_foils$strong_foil %>%
  select(-Semantic) %>% 
  knitr::kable(
    caption = "Items used for the analysis of phonological versus unrelated competitors.")
```
...
semy_foils$strong_foil %>%
  select(-Phonological) %>% 
  knitr::kable(
    caption = "Items used for the analysis of semantic versus unrelated competitors.")
```
